...
@Component({
  selector: 'app-table-view-sub',
  templateUrl: './table-view-sub.component.html',
  styleUrls: ['./table-view-sub.component.scss']
})
export class TableViewSubComponent implements OnInit {
