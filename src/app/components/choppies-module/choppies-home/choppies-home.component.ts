...
@Component({
  selector: 'app-choppies-home',
  templateUrl: './choppies-home.component.html',
  styleUrls: ['./choppies-home.component.css']
})
export class ChoppiesHomeComponent implements OnInit {
  ...
  itemClick(item) {
    ...
    this.productCommodityDetails = this.productCommoditiesList.filter(x => x.shopId == ShopEnum.CHOPPIES)
  ...
  itemClick3(item) {
    ...
    this.selected = item;
    this.subTitle = item.name;  
    this.formViewTitle = ShopNameEnum.CHOPPIES;
