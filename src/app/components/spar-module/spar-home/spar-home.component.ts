...
@Component({
  selector: 'app-spar-home',
  templateUrl: './spar-home.component.html',
  styleUrls: ['./spar-home.component.css']
})
export class SparHomeComponent implements OnInit {
  ...
  itemClick(item) {
    ...
    this.productCommodityDetails = this.productCommoditiesList.filter(x => x.shopId == ShopEnum.SPAR)
  ...
  itemClick3(item) {
    ...
    this.selected = item;
    this.subTitle = item.name; 
    this.formViewTitle = ShopNameEnum.SPAR; 
